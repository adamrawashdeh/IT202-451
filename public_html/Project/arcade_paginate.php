...
$base_query = "SELECT id, name, current_participants, current_reward, min_score, expires, IF(expires > current_timestamp(), 'Active', 'Expired') as Status FROM Competitions items";
